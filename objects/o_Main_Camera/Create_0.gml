...
camera_Show_Width  = global.view_width;  // EDIT ONLY HERE
camera_Show_Height = global.view_height;  // EDIT ONLY HERE
display_set_gui_size(camera_Show_Width, camera_Show_Height);
/// Rest is auto
...
target = o_player;   // stick to target, can be changed dynamically to jump to other places
